# ADR 0001: @plasius/game-audio-spatial Package Boundary
...
Keep acoustic obstruction estimation independent from renderer internals. Scene and physics packages provide optional adapter data; this package normalizes the acoustic result for runtime adapters.

This package uses `game.audio.sfx-occlusion.enabled` as its initial rollout flag. Product hosts remain responsible for remote flag evaluation and any capability checks required for user-visible controls or diagnostics.
